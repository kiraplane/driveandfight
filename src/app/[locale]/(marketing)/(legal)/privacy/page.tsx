...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Privacy Policy | Drive and Fight Wiki',
    description:
      'Privacy policy for the independent Drive and Fight Wiki and Roblox guide site.',
    locale,
    pathname: '/privacy',
  });
}
    ...
    <div className="bg-[#0B0D0C] py-12 text-[#F8FAFC]">
      <Container className="max-w-3xl space-y-6 px-4">
        ...
        <p className="leading-8 text-[#CBD5E1]">
          Drive and Fight Wiki is an independent Roblox guide site. We do not
          require accounts for browsing codes, truck routes, supply guides,
          update coverage, official links, or safety pages.
        </p>
        <p className="leading-8 text-[#CBD5E1]">
        ...
        <p className="leading-8 text-[#CBD5E1]">
          Privacy questions can be sent to hello@driveandfight.wiki.
        </p>
      </Container>
    </div>
  );
