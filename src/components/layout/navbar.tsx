...
const customNavigationMenuTriggerStyle = cn(
  ...
  'hover:bg-white/5 hover:text-[#F3A23A]',
  'focus:bg-white/5 focus:text-[#F3A23A]',
  'data-active:bg-transparent data-active:font-semibold data-active:text-[#F3A23A]',
  'data-[state=open]:bg-white/5 data-[state=open]:text-[#F3A23A]'
);
  ...
  return (
    <section
      className={cn(
        ...
        scroll
          ? scrolled
            ? 'bg-[#0B0D0C]/95 backdrop-blur-md supports-backdrop-filter:bg-[#0B0D0C]/95'
            : 'bg-[#0B0D0C]/90 backdrop-blur-md'
          : 'bg-[#0B0D0C]/95 backdrop-blur-md'
      )}
    >
