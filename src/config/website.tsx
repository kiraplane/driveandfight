...
export const websiteConfig: WebsiteConfig = {
  ...
  metadata: {
    images: {
      ...
      logoLight: '/driveandfight/icon.png',
      logoDark: '/driveandfight/icon.png',
    },
    social: {
      github: '',
      twitter: '',
  ...
  mail: {
    provider: 'resend',
    fromEmail: 'Drive and Fight Wiki <hello@driveandfight.wiki>',
    supportEmail: 'hello@driveandfight.wiki',
  },
  newsletter: {
    enable: false,
    provider: 'resend',
