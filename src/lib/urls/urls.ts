...
export const CANONICAL_BASE_URL = 'https://www.driveandfight.wiki';
...
function getDriveAndFightBaseUrl(url?: string) {
  ...
  try {
    ...
    if (
      parsedUrl.hostname === 'driveandfight.wiki' ||
      parsedUrl.hostname === 'www.driveandfight.wiki'
    ) {
...
export function getBaseUrl(): string {
  ...
  const driveAndFightBaseUrl = getDriveAndFightBaseUrl(configuredBaseUrl);
  if (driveAndFightBaseUrl) {
    return driveAndFightBaseUrl;
  }
