...
const retiredPublicRouteRedirects: Array<{
  ...
  { pattern: /^\/driveandfight-codes?\/?$/, target: '/codes' },
  {
    pattern: /^\/driveandfight-tier-list\/?$/,
    target: '/guides',
  },
  { pattern: /^\/driveandfight-wiki\/?$/, target: '/' },
];
...
export default async function middleware(req: NextRequest) {
  ...
  const productionHosts = new Set([
    'driveandfight.wiki',
    'www.driveandfight.wiki',
  ]);
  const canonicalHost = 'www.driveandfight.wiki';
