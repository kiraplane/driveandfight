...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Cookie Policy | Drive and Fight Wiki',
    description:
      'How Drive and Fight Wiki uses essential cookies, analytics, and similar technologies.',
    locale,
    pathname: '/cookie',
  });
}
    ...
    <div className="bg-[#0B0D0C] py-12 text-[#F8FAFC]">
      <Container className="max-w-3xl space-y-6 px-4">
        ...
        <p className="leading-8 text-[#CBD5E1]">
          Drive and Fight Wiki uses essential cookies and similar technologies
        ...
        <p className="leading-8 text-[#CBD5E1]">
          Questions about this policy can be sent to hello@driveandfight.wiki.
        </p>
      </Container>
    </div>
  );
