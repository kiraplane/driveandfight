...
export const guides: Guide[] = [
  {
    ...
    sourceNotes:
      'Official game description, badges, current Roblox APIs, and exact-Place gameplay checked July 29, 2026. Volatile objective order and prices remain tied to the live game.',
