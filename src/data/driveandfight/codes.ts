...
export const codeStatusSummary = {
  ...
  nextMilestone: '50,000 likes',
  message:
    '25KLIKES is published in the current official Roblox description. Another code is promised at 50,000 likes, but no unreleased string is listed.',
};
